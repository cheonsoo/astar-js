 ...
 GraphSearch.prototype.initialize = function() {
   ...
   function Cell({ x, y }) {
     ...
     _cell.addEventListener("click", () => {
       console.log(`### clicked: nodeType: ${nodeTypeDef[nodeType]}, x: ${x}, y: ${y}`);
       console.log(_astarMap.graph);
      //  const start = _astarMap.nodes.filter(item => item === "s");
      //  const end = _astarMap.nodes.filter(item => item === "e");
